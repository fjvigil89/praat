...
import utils # import compute_score_multiclass, zscore
from collections import Counter
import matplotlib.pyplot as plt

def main(base, kfold, audio_type, resumen = True):
    ...
    for k in range(0,kfold):
        ...
        sizes = []
        print('Cantidad por Clases')
        for i in labels:
            sizes.append(counter[data['labels'][i]])

            print(i + ' = ' + str(counter[data['labels'][i]]))
        '''
        plt.subplot(121)
