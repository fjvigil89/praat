...
def export_csv():    
    ...
    for r, d, f in os.walk(data_path):     
        for d in d:
            ...
            for r, d, f in os.walk(path):    
                for file in f:                    
                    if '.json' in file and (file.split('_')[1].split('.')[0]=="4" or file.split('_')[1].split('.')[0]=="5" or file.split('_')[1].split('.')[0]=="6" or file.split('_')[1].split('.')[0]=="7" or file.split('_')[1].split('.')[0]=="8" or file.split('_')[1].split('.')[0]=="9" or file.split('_')[1].split('.')[0]=="10"):
                        try:
    ...
    df.to_excel("data/xlsx/dataset_tuvoz_frase.xlsx")
