...
if __name__ == '__main__':
    X = list(range(18)) # id de las muestras
    y = [1] * 6 + [0] * 12 # id de las clases, o sea por cada id de la clase existen varias muestras
    groups = [1, 2, 3, 3, 4, 4, 1, 1, 2, 2, 3, 4, 5, 5, 5, 6, 6, 6] # id de los locutores, en la posicion 0 en el arreglo esta el id del locutor que le pertenece la muestra en la posicion 0.
