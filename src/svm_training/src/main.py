...
tipo_signal = 'LECTURA'  # 'D8_LECTURA'
...
# Crea_list_kfold.selecciona_conjuntos_Cross_validation('multiclases2binarias', 'StratifiedGroupKFold', 2, base,
...
run_baseline.main_with_thalento('data/lst/' + base_train, 'data/lst/' + base_test, 5, tipo_signal, tipo_signal_test, 'viejo', 'binaria')
